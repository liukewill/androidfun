...
public class NettyClient implements INettySender,INettyHandler {
    ...
    public static long getHear_beat_time() {
        return hear_beat_time;
    }

    public static void setHear_beat_time(long hear_beat_time) {
        NettyClient.hear_beat_time = hear_beat_time;
    }
    ...
    public INettySender getiNettySender() {
        return iNettySender;
    }

    public void setiNettySender(INettySender iNettySender) {
