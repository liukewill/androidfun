package com.example.androidrx.aes;
...
public class AESUtil {
   ...
   */
   ...
   public static final int SECRET_KEY_LENGTH = 16;
    ...
    // 补全秘钥时使用的默认字符串
    public static final String DEFAULT_FILLING_STR = "0";
    ...
    // 用户生成文件加密、解密秘钥的字符串
    public static final String KEY_PART = "466766766676597E15856FC9";

    public static final String FILE_KEY_PART_YEAR = "1988";

  // DexClassLoader类名进行加密后的结果字符串
  public static final String R_NAME = "1511444DD9EEF3E2C7205DCA0CC4D194525A533DEA7CE97F9886B9B2668AB223";
  // loadClass方法加密后的结果字符串
  public static final String M_NAME = "4D1E2BAC18AB1B49764F3392B5BF16B1";
